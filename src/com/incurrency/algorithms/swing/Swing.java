            ...
            if (this.tradingWindow.get()) {
                ...
                if (getStrategySymbols().contains(id) && !Parameters.symbol.get(id).getType().equals(referenceCashType)) {
                    if (this.getPosition().get(id).getPosition() != 0 && this.getPosition().get(id).getStrategy().equalsIgnoreCase(this.getStrategy())) {
                        ...
                        ArrayList<Stop> stops = Trade.getStop(this.getDb(), this.getStrategy() + ":" + this.EntryInternalOrderIDForSquareOff(0, "Order", getStrategy(),derivedSide) + ":Order");
                        ...
                        if ((slTrigger || tpTrigger)) {
                            ...
                            String entryTime = Trade.getEntryTime(this.getDb(), this.getStrategy() + ":" + this.EntryInternalOrderIDForSquareOff(0, "Order", getStrategy(),derivedSide) + ":Order");
