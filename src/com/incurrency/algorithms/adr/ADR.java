...
public class ADR extends Strategy implements TradeListener, UpdateListener {
    ...
    public ADR(MainAlgorithm m, String parameterFile, ArrayList<String> accounts) {
        ...
        TradingUtil.writeToFile(getStrategy() + ".csv", "buyZone,ShortZone,adr,adrHigh,adrLow,adrDayHigh,adrDayLow,adrAvg,BuyZone1,ShortZone1,index,indexHigh,indexLow,indexDayHigh,indexDayLow,indexAvg,BuyZone2,ShortZone2,adrTRIN,adrTRINAvg,BuyZone3,ShortZone3,tick,tickTRIN,adrTRINHigh,adrTRINLow,Comment");
...
//                    || (adrDayHigh - adrDayLow > 10 && adr < adrDayHigh - 0.75 * (adrDayHigh - adrDayLow) && adr < adrAvg));// && adrTRIN > 95;
             ...
             */
            TradingUtil.writeToFile(getStrategy() + ".csv", buyZone + "," + shortZone + "," + adr + "," + adrHigh + "," + adrLow + "," + adrDayHigh + "," + adrDayLow + "," + adrAvg + "," + buyZone1 + "," + shortZone1 + "," + price + "," + indexHigh + "," + indexLow + "," + indexDayHigh + "," + indexDayLow + "," + indexAvg + "," + buyZone2 + "," + shortZone2 + "," + adrTRIN + "," + adrTRINAvg + "," + buyZone3 + "," + shortZone3 + "," + tick + "," + tickTRIN + "," + adrTRINHigh + "," + adrTRINLow + "," + "SCAN");
            ...
            if (getPosition().get(id) == 0 && new Date().compareTo(getEndDate()) < 0) {
                if (tradingSide == 0 && buyZone && (tick < 45 || tickTRIN > 120) && getLongOnly() && price > indexHigh - 0.75 * stopLoss) {
                    ...
                    tradingSide = 1;
                    TradingUtil.writeToFile(getStrategy() + ".csv", buyZone + "," + shortZone + "," + adr + "," + adrHigh + "," + adrLow + "," + adrDayHigh + "," + adrDayLow + "," + adrAvg + "," + buyZone1 + "," + shortZone1 + "+" + index + "," + indexHigh + "," + indexLow + "," + indexDayHigh + "," + indexDayLow + "," + indexAvg + "," + buyZone2 + "," + shortZone2 + "," + adrTRIN + "," + adrTRINAvg + "," + buyZone3 + "," + shortZone3 + "," + tick + "," + tickTRIN + "," + adrTRINHigh + "," + adrTRINLow + "," + "BUY");
                    ...
                    tradingSide = -1;
                    TradingUtil.writeToFile(getStrategy() + ".csv", buyZone + "," + shortZone + "," + adr + "," + adrHigh + "," + adrLow + "," + adrDayHigh + "," + adrDayLow + "," + adrAvg + "," + buyZone1 + "," + shortZone1 + "+" + index + "," + indexHigh + "," + indexLow + "," + indexDayHigh + "," + indexDayLow + "," + indexAvg + "," + buyZone2 + "," + shortZone2 + "," + adrTRIN + "," + adrTRINAvg + "," + buyZone3 + "," + shortZone3 + "," + tick + "," + tickTRIN + "," + adrTRINHigh + "," + adrTRINLow + "," + "SHORT");
                    ...
                    TradingUtil.writeToFile(getStrategy() + ".csv", buyZone + "," + shortZone + "," + adr + "," + adrHigh + "," + adrLow + "," + adrDayHigh + "," + adrDayLow + "," + adrAvg + "," + buyZone1 + "," + shortZone1 + "+" + index + "," + indexHigh + "," + indexLow + "," + indexDayHigh + "," + indexDayLow + "," + indexAvg + "," + buyZone2 + "," + shortZone2 + "," + adrTRIN + "," + adrTRINAvg + "," + buyZone3 + "," + shortZone3 + "," + tick + "," + tickTRIN + "," + adrTRINHigh + "," + adrTRINLow + "," + "SCALPING BUY");
                    ...
                    entry(id, EnumOrderSide.SHORT, entryPrice, 0, true);
                    getPosition().put(id, -1);
                    TradingUtil.writeToFile(getStrategy() + ".csv", buyZone + "," + shortZone + "," + adr + "," + adrHigh + "," + adrLow + "," + adrDayHigh + "," + adrDayLow + "," + adrAvg + "," + buyZone1 + "," + shortZone1 + "+" + index + "," + indexHigh + "," + indexLow + "," + indexDayHigh + "," + indexDayLow + "," + indexAvg + "," + buyZone2 + "," + shortZone2 + "," + adrTRIN + "," + adrTRINAvg + "," + buyZone3 + "," + shortZone3 + "," + tick + "," + tickTRIN + "," + adrTRINHigh + "," + adrTRINLow + "," + "SCALPING SHORT");
                }
                ...
                if (buyZone || ((price > indexLow + stopLoss && !shortZone) || (price > entryPrice + stopLoss)) || new Date().compareTo(getEndDate()) > 0) { //stop loss
                    ...
                    tradingSide = 0;
                    TradingUtil.writeToFile(getStrategy() + ".csv", buyZone + "," + shortZone + "," + adr + "," + adrHigh + "," + adrLow + "," + adrDayHigh + "," + adrDayLow + "," + adrAvg + "," + buyZone1 + "," + shortZone1 + "+" + index + "," + indexHigh + "," + indexLow + "," + indexDayHigh + "," + indexDayLow + "," + indexAvg + "," + buyZone2 + "," + shortZone2 + "," + adrTRIN + "," + adrTRINAvg + "," + buyZone3 + "," + shortZone3 + "," + tick + "," + tickTRIN + "," + adrTRINHigh + "," + adrTRINLow + "," + "COVER STOP LOSS");
                    ...
                    getPosition().put(id, 0);
                    lastShortExit = price;
                    TradingUtil.writeToFile(getStrategy() + ".csv", buyZone + "," + shortZone + "," + adr + "," + adrHigh + "," + adrLow + "," + adrDayHigh + "," + adrDayLow + "," + adrAvg + "," + buyZone1 + "," + shortZone1 + "+" + index + "," + indexHigh + "," + indexLow + "," + indexDayHigh + "," + indexDayLow + "," + indexAvg + "," + buyZone2 + "," + shortZone2 + "," + adrTRIN + "," + adrTRINAvg + "," + buyZone3 + "," + shortZone3 + "," + tick + "," + tickTRIN + "," + adrTRINHigh + "," + adrTRINLow + "," + "COVER TAKE PROFIT");
                }
            } else if (getPosition().get(id) == 1) {
                if (shortZone || ((price < indexHigh - stopLoss && !buyZone) || (price < entryPrice - stopLoss)) || new Date().compareTo(getEndDate()) > 0) {
                    ...
                    getPosition().put(id, 0);
                    TradingUtil.writeToFile(getStrategy() + ".csv", buyZone + "," + shortZone + "," + adr + "," + adrHigh + "," + adrLow + "," + adrDayHigh + "," + adrDayLow + "," + adrAvg + "," + buyZone1 + "," + shortZone1 + "+" + index + "," + indexHigh + "," + indexLow + "," + indexDayHigh + "," + indexDayLow + "," + indexAvg + "," + buyZone2 + "," + shortZone2 + "," + adrTRIN + "," + adrTRINAvg + "," + buyZone3 + "," + shortZone3 + "," + tick + "," + tickTRIN + "," + adrTRINHigh + "," + adrTRINLow + "," + "SELL STOP LOSS");
                    ...
                    getPosition().put(id, 0);
                    lastLongExit = price;
                    TradingUtil.writeToFile(getStrategy() + ".csv", buyZone + "," + shortZone + "," + adr + "," + adrHigh + "," + adrLow + "," + adrDayHigh + "," + adrDayLow + "," + adrAvg + "," + buyZone1 + "," + shortZone1 + "+" + index + "," + indexHigh + "," + indexLow + "," + indexDayHigh + "," + indexDayLow + "," + indexAvg + "," + buyZone2 + "," + shortZone2 + "," + adrTRIN + "," + adrTRINAvg + "," + buyZone3 + "," + shortZone3 + "," + tick + "," + tickTRIN + "," + adrTRINHigh + "," + adrTRINLow + "," + "SELL TAKE PROFIT");                }
            }
        }
    }
