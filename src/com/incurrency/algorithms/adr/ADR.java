...
//                    || (adrDayHigh - adrDayLow > 10 && adr < adrDayHigh - 0.75 * (adrDayHigh - adrDayLow) && adr < adrAvg));// && adrTRIN > 95;
            ...
            if ((!buyZone && tradingSide == 1 && getPosition().get(id).getSymbolPosition() == 0) || (!shortZone && tradingSide == -1 && getPosition().get(id).getSymbolPosition() == 0)) {
            ...
            if (getPosition().get(id).getSymbolPosition()  == 0 && new Date().compareTo(getEndDate()) < 0) {
            ...
            } else if (getPosition().get(id).getSymbolPosition()  <0) {
