 ...
 * @author pankaj
 */
public class OGT extends Manager implements TradeListener {

    private static final Logger logger = Logger.getLogger(OGT.class.getName());
    int testingTimer = 0;
    ...
    public OGT(MainAlgorithm m, Properties p, String parameterFile, ArrayList<String> accounts, Integer stratCount) {
    ...
    private void bodtasks() {
        ...
        for (String key : this.getDb().getKeys("opentrades_" + this.getStrategy())) {
            ...
            String entryside = this.getDb().getValue("opentrades", key, "entryside");
